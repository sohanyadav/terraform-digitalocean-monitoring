...
```hcl
module "uptime-alert" {
  source      = "git::https://github.com/sohanyadav/terraform-digitalocean-monitoring.git?ref=v1.0.0"
  name        = "side"
  environment = "testing"
...
# Examples
For detailed examples on how to use this module, please refer to the '[example](https://github.com/sohanyadav/terraform-digitalocean-monitoring/tree/master/_examples)'directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/sohanyadav/terraform-digitalocean-monitoring/blob/master/LICENSE) file for details.
